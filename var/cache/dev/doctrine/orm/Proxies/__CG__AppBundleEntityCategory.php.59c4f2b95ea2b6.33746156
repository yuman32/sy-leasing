...
class Category extends \AppBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'photo', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'parent');
        }
