...
class Product extends \AppBundle\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Product' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Product' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Product' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Product' . "\0" . 'photo', '' . "\0" . 'AppBundle\\Entity\\Product' . "\0" . 'price', '' . "\0" . 'AppBundle\\Entity\\Product' . "\0" . 'minPrice', '' . "\0" . 'AppBundle\\Entity\\Product' . "\0" . 'category');
        }
    ...
    public function setMinPrice($minPrice)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMinPrice', array($minPrice));
    ...
    public function getMinPrice()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMinPrice', array());
